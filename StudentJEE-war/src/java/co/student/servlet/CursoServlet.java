 ...
 */
package co.student.servlet;

import co.student.entity.Curso;
import co.student.session.CursoFacadeLocal;
...
public class CursoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Integer numeroestudiantes=Integer.parseInt(request.getParameter("numeroestudiantes"));
        
        
        Curso curso=new Curso(idcurso,nombrecurso,creditos,semestre,numeroestudiantes);
