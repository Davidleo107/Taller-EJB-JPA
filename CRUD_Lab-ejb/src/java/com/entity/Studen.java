...
public class Studen implements Serializable {
    ...
    private Boolean yearlevel;

    public Studen() {
    }

    public Studen(String studentid) {
    ...
    public Boolean getYearlevel() {
        return yearlevel;
    }

    public void setYearlevel(Boolean yearlevel) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Studen)) {
            return false;
        }
        Studen other = (Studen) object;
